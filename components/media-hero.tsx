    ...
    <section className="relative overflow-hidden border-b border-hairline bg-arm-media/[0.045]">
      <div className="relative mx-auto max-w-6xl px-6 py-16 sm:px-8 lg:py-24">
        <div className="flex items-center justify-between border-b border-arm-media/25 pb-4">
          <p className="text-xs font-semibold tracking-[0.22em] text-arm-media-ink uppercase">
            {arm.kicker}
          </p>
          <span aria-hidden className="hidden h-px flex-1 bg-arm-media/20 sm:mx-6 sm:block" />
          <p className="hidden text-xs font-semibold tracking-[0.22em] text-muted-ink uppercase sm:block">
        ...
        <div className="relative grid gap-10 pt-10 lg:grid-cols-[1.2fr_0.8fr] lg:gap-16 lg:pt-14">
          <div className="relative z-10 max-w-xl">
            <h1 className="font-display text-5xl leading-[1.05] font-semibold tracking-tight text-ink sm:text-6xl lg:text-7xl">
              Media &amp;
              <br />
            ...
            <p className="mt-4 text-sm text-muted-ink">For: {arm.audience}</p>
            <div className="mt-8">
          ...
          >
            ...
            <p className="font-display absolute right-0 bottom-2 max-w-[15rem] text-right text-lg leading-snug text-ink/70 italic">
        ...
        <p className="font-display mt-10 max-w-xs text-lg leading-snug text-ink/70 italic lg:hidden">
          Ideas should move beyond the room.
        </p>
      </div>
    </section>
